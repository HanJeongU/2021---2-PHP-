...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">가격. <?php echo htmlentities($row['productPrice']);?></span><br>
											<span class="price-strike">할인.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
