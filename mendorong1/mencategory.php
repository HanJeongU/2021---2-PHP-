...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/cat-banner-1.jpg" text="멘토 찾기" alt="" class="img-responsive" >
...
while($row=mysqli_fetch_array($sql))
{
    ?>
			...
			<?php
            $university = $_GET["university"];
$ret=mysqli_query($con,"select * from products where university='$university' ");
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					가격. <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">할인. <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
